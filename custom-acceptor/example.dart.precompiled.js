...
$isiP:true,
static:{"^":"Oj,bI,Ej,p2,ch,QC,nm,Yp,kc,Gi,Fz,cR,E0,Ke,Cg,Nr,Dk,FI,Kz,LT,yf,I2",Wu:function(a,b){var z=new P.iP(a,b)
z.RM(a,b)
...
$isa6:true,
static:{"^":"Wt,VR,dk,Lo,zj,b2,jS,Ie,Do,Cv,kT,IJ,D9,Vk,S8,rG",k5:function(a,b,c,d,e,f){return new P.a6(a*86400000000+b*3600000000+e*60000000+f*1000000+d*1000+c)}}},
P7:{
"^":"Tp:49;",
...
u4:{
"^":"Tp:25;a",
$1:[function(a){if(J.Zm(a)===27)this.a.ZY.OF(a,null,!0)},"$1",null,2,0,null,52,"call"],
$isEH:true},
zR:{
"^":"Tp:25;b",
$1:[function(a){this.b.ZY.OF(a,null,!0)},"$1",null,2,0,null,51,"call"],
$isEH:true},
DZ:{
"^":"Tp:25;",
...
Bh:{
"^":"Tp:53;a",
$1:[function(a){this.a.ZY.OF(a,null,!0)},"$1",null,2,0,null,51,"call"],
$isEH:true},
Bn:{
"^":"qn;er,i5,ZY",
...
y=H.VM(new W.xC(0,y.J6,y.fA,W.VF(this.gTu()),y.el),[H.Kp(y,0)])
y.DN()
...
y=x}else y=!0
if(y)J.pP(H.Go(z.gSd(a),"$iscv")).h(0,this.SK)},"$1","gRi",2,0,56,51],
HC:[function(a){var z,y
z=this.w6
if(z!=null){y=$.IE
y=z.TY(y.FL,y.Dh,J.BC(a))
z=y}else z=!0
if(z);},"$1","gbc",2,0,56,51],
...
x=y.TY(x.FL,x.Dh,z.gSd(a))
y=x}else y=!0
if(y)J.pP(H.Go(z.gSd(a),"$iscv")).Rz(0,this.SK)},"$1","gVm",2,0,56,51],
BM:[function(a){var z,y
z=this.w6
if(z!=null){y=$.IE
y=z.TY(y.FL,y.Dh,J.BC(a))
z=y}else z=!0
if(z);},"$1","gTu",2,0,56,51],
...
Z.VK(document.querySelector("#dropzone-3"),new U.Ww(),"dnd-over")},"$0","HA",0,0,32],
Ww:{
"^":"FP;",
TY:function(a,b,c){var z=J.c1(a,"input")
return z!=null&&J.Vm(z)==="acceptme"}}},1],["","",,P,{
"^":"",
...
init.metadata=["object","sender","e",{func:"uO",args:[P.qU]},"closure","isolate","numberOfArguments","arg1","arg2","arg3","arg4",{func:"n9",void:true,args:[{func:"X0",void:true}]},{func:"X0",void:true},{func:"G5",void:true,args:[null]},"value",{func:"mQ",void:true,args:[null],opt:[P.mE]},,"error","stackTrace",{func:"Ib",ret:P.a2,args:[null,null]},{func:"bX",ret:P.KN,args:[null]},"a",{func:"Vs",ret:P.KN,args:[P.fR,P.fR]},{func:"E0",ret:P.a2,args:[P.a,P.a]},{func:"DZ",ret:P.KN,args:[P.a]},{func:"aB",args:[null]},"callback","captureThis","self","arguments","o",{func:"uJ",ret:P.a,args:[null]},{func:"NT"},{func:"cH",ret:P.KN},{func:"bh",args:[null,null]},{func:"Za",args:[P.qU,null]},{func:"TS",args:[null,P.qU]},"_",{func:"xO",args:[{func:"X0",void:true}]},{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:P.a2},"ignored","element",{func:"bb",args:[null,P.mE]},"data",{func:"N5",void:true,args:[null,P.mE]},"arg","each",{func:"lv",args:[P.wv,null]},{func:"Pt",ret:P.qU,args:[P.KN]},"time","event","keyboardEvent",{func:"Yt",args:[W.y6]},{func:"XF",args:[W.Aj]},{func:"Km",args:[W.cv]},{func:"bB",void:true,args:[W.Aj]},];$=null
...
if($desc instanceof Array)$desc=$desc[1]
TZ.prototype=$desc
function ZN(Dh,FL,m2,GB,x8,Uh,CY,lA){this.Dh=Dh
this.FL=FL
this.m2=m2
this.GB=GB
this.x8=x8
...
if($desc instanceof Array)$desc=$desc[1]
GE.prototype=$desc
return[qE,Gh,rK,F6,LL,fY,Mr,lJ,ct,nB,it,Az,QP,IF,n6,Ny,nx,QQ,MA,y4,TR,Um,oJ,DG,mN,vH,xO,qs,Em,NW,rV,Wy,QF,Ec,cm,Nh,cv,Fs,hY,ea,D0,zZ,as,hH,Aa,u5,Yu,xk,iG,jP,FO,xf,ik,ST,tb,Sg,pA,Mi,KD,Ln,HL,In,wP,eP,AL,Og,M6,El,mC,SV,aB,fJ,Ih,D8,Vh,rC,ZY,cx,Ee,Qb,PG,F3,xI,Aj,oU,Q0,ih,KV,KY,G7,l9,Ql,wL,bP,mX,SN,HD,nU,ni,rR,qj,nC,KR,ew,Mw,fs,bX,A6,MC,Mx,j2,Ea,lp,Hv,kd,I0,yN,Cp,zD,Ul,KK,ii,fq,h4,qk,GI,Tb,Iv,BT,yY,kJ,FB,xV,FH,a9,y6,o4,RH,Kn,Z2,OR,BR,vw,aG,J6,K5,Xg,UM,YC,hq,r0,yp,AK,Mq,nK,Nc,rj,yK,Zv,Q7,hF,OF,Y0,ZJ,mU,ph,IT,JY,Pq,kx,nV,Zc,ui,D6,DQ,Sm,xL,QU,es,jw,lv,pf,NV,W1,HC,wf,TC,bb,Nd,zp,Xu,lu,v6,me,oB,nh,yu,MI,Ub,bM,eW,Qy,ju,OE,f1,BA,d0,tp,rE,CC,PQ,uz,Yd,U0,AD,Gr,tc,GH,To,NJ,qI,Pu,rQ,Lx,d5,hy,mq,aS,CG,Kf,jk,Rk,Eo,YS,ci,GR,vt,cu,BD,vR,Ja,zI,cB,LQ,yR,HP,fa,l4,Et,NC,Pi,qO,xt,cO,P0,xl,Xr,Ck,Qm,aT,ET,df,zU,K8,xj,dE,ZA,dT,nl,LN,V6,eo,Gv,kn,YE,Ue,iC,is,Q,no,P,bU,VA,O,PK,JO,pq,aX,NY,cC,RA,IY,JH,jl,vK,Iy,JM,Ua,ns,yo,Bj,NO,II,fP,X1,HU,oo,OW,Tf,iY,yH,FA,Av,ku,LI,FD,Nv,Cj,u8,Zr,W0,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,Bp,v,Pe,Eq,lb,tD,hJ,dC,wN,VX,aL,a7,i1,xy,MH,A8,Lj,GD,th,ha,C6,Ft,O6,b8,w4,Pf,mJ,vs,da,pV,U7,rq,RW,YP,jZ,FZ,OM,qh,lz,Rl,Jb,M4,B5,PI,MO,nP,KA,Vo,qB,aA,LV,DS,dp,B3,CR,Qk,dR,uR,YR,fB,t3,OH,m0,pK,R8,hj,MK,pQ,FG,k6,oi,fG,EQ,YB,a1,db,i5,N6,b6,tj,zQ,u3,mW,FN,LG,Sw,o0,lf,Vj,Y2,CL,a2,fR,iP,CP,a6,P7,DW,Ge,LK,AT,bJ,JS,ub,ds,lj,UV,VS,t7,HG,oe,eV,kM,KN,An,zM,L9,FK,a,mE,qU,Rn,wv,BV,id,Jn,DM,zL,ec,TH,dx,x5,tJ,i7,I4,Fk,RO,Cq,xC,Pb,W9,dW,O7,IU,E4,r7,Tz,Wk,DV,PC,Nz,Jd,QS,hL,IN,tn,b0,Dg,Ob,GV,Pg,fj,Ip,tv,vf,Oa,TZ,ZN,Oh,oL,qQ,r8,q8,zE,qn,u4,zR,DZ,Vb,jG,SP,Yr,Bh,Bn,a3,kK,yq,QM,lM,H8,rc,SI,yQ,xp,FP,rf,qG,Ww,As,GE]}